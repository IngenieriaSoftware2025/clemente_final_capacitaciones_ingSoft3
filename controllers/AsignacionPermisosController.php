...
class AsignacionPermisosController extends ActiveRecord
{
    ...
    public static function guardarAPI()
    {
        ...
        try {
            ...
            $verificarPermisoExiste = self::fetchArray("SELECT permiso_id FROM avpc_permiso WHERE permiso_id = {$_POST['asignacion_permiso_id']} AND app_id = {$_POST['asignacion_app_id']} AND permiso_situacion = 1");
            ...
            $verificarDuplicado = self::fetchArray("SELECT asignacion_id FROM avpc_asig_permisos WHERE asignacion_usuario_id = {$_POST['asignacion_usuario_id']} AND asignacion_permiso_id = {$_POST['asignacion_permiso_id']} AND asignacion_situacion = 1");
    ...
    public static function buscarAPI()
    {
        try {
            ...
            $sql = "SELECT 
                    ...
                    FROM avpc_asig_permisos ap 
                    INNER JOIN avpc_usuario u ON ap.asignacion_usuario_id = u.usuario_id
                    INNER JOIN avpc_aplicacion a ON ap.asignacion_app_id = a.app_id 
                    INNER JOIN avpc_permiso p ON ap.asignacion_permiso_id = p.permiso_id
                    INNER JOIN avpc_usuario ua ON ap.asignacion_usuario_asigno = ua.usuario_id
                    WHERE $where 
    ...
    public static function modificarAPI()
    {
        ...
        try {
            ...
            $verificarDuplicado = self::fetchArray("SELECT asignacion_id FROM avpc_asig_permisos WHERE asignacion_usuario_id = {$_POST['asignacion_usuario_id']} AND asignacion_permiso_id = {$_POST['asignacion_permiso_id']} AND asignacion_situacion = 1 AND asignacion_id != {$id}");
