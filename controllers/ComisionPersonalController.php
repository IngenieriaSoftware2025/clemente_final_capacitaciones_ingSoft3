...
class ComisionPersonalController extends ActiveRecord
{
    ...
    public static function guardarAPI()
    {
        ...
        try {
            ...
            $verificarComisionActiva = self::fetchArray("SELECT c.comision_id FROM avpc_comision c 
                                                       INNER JOIN avpc_comision_personal cp ON c.comision_id = cp.comision_id 
            ...
            $verificarDuplicado = self::fetchArray("SELECT comision_personal_id FROM avpc_comision_personal 
    ...
    public static function buscarAPI()
    {
        try {
            ...
            $sql = "SELECT 
                    ...
                    INNER JOIN avpc_usuario ua ON cp.comision_personal_usuario_asigno = ua.usuario_id
                    WHERE $where 
