        ...
        <div class="col-lg-6 col-md-8">
          ...
          <form id="FormLogin">
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-muted mb-5">Sistema de Gestión de Comisiones</p>
              ...
              <div class="d-flex justify-content-center text-center mt-4 pt-1">
                ...
                <a href="#!" class="text-muted"><i class="fab fa-twitter fa-lg mx-4 px-2"></i></a>
                <a href="#!" class="text-muted"><i class="fab fa-google fa-lg"></i></a>
              </div>

              <div class="text-center mt-4">
                <p class="mb-0">¿No tienes cuenta? <a href="#!" class="text-muted fw-bold">Contacta al administrador</a></p>
              </div>
