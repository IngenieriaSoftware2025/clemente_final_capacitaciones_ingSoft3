    ...
    <div class="row mb-4 justify-content-center">
        <div class="col-lg-10">
            <div class="alert alert-info">
                ...
                <p class="mb-0">Este sistema registra automáticamente todas las actividades de los usuarios para fines de auditoría y seguridad. Los datos se organizan por módulos para facilitar el análisis.</p>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow-lg border-primary rounded-4" style="width: 98%;">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-bordered align-middle rounded-3 overflow-hidden w-100" id="TableActividades" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Usuario</th>
