        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3" style="background: none;" href="/clemente_final_capacitaciones_ingSoft3/comisiones">
                            <i class="bi bi-clipboard-data-fill me-2"></i>Comisiones
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link px-3" style="background: none;" href="/clemente_final_capacitaciones_ingSoft3/comisionpersonal">
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/clemente_final_capacitaciones_ingSoft3/mapa"><i class="ms-lg-0 ms-2 bi bi-geo-alt-fill me-2"></i>Mapa</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/clemente_final_capacitaciones_ingSoft3/historial"><i class="ms-lg-0 ms-2 bi bi-clock-history me-2"></i>Historial de Actividades</a>
                            </li>
                        </ul>
                    </div> 
